    ...
    <section className={styles.servicesSection}>
      ...
      <div className={styles.servicesContainer}>
        ...
        <div className={styles.serviceCard}>
          ...
          <p>Community clean-up drives aimed at combating pollution and promoting cleanliness.</p>
        </div>
        <div className={styles.serviceCard}>
          ...
          <p>Educational programs to promote sustainability and environmental stewardship.</p>
        </div>
      </div>
    </section>
  );
